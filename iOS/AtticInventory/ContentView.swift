...
struct ContentView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Attic Inventory")
            .toolbar {
...
struct EntryFormView: View {
    ...
    init(mode: EntryFormMode) {
        ...
        if case .edit(let entry) = mode {
            ...
            _binLocation = State(initialValue: entry.binLocation)
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                TextField("Item / Bin Location", text: $binLocation)
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    ...
                    .disabled(binLocation.trimmingCharacters(in: .whitespaces).isEmpty)
                }
            }
        }
    }
    ...
    private func save() {
        switch mode {
        case .add:
            let entry = ItemEntry(date: date, binLocation: binLocation, notes: notes)
            store.add(entry)
        case .edit(let existing):
            var updated = existing
            updated.date = date
            updated.binLocation = binLocation
            updated.notes = notes
